...
-- observation:
--
-- when examiniing the performance statistics produced by 
-- the run, i noticed that there were about 26,563 sparks created and and to
-- reconcile that, i noticed that there are 235,886 lines in the words
-- dictionary and a division reveals that 1 spark was created for every 8
-- lines found in the dictionary. Question is whether this is the correct
-- derivation? idk tbh.
--
